...
const $body = $("<img>").attr("src", "/acornOS/assets/images/paulie/body-smirk.svg").addClass("body");
const $shadow = $("<img>").attr("src", "/acornOS/assets/images/paulie/shadow.svg").addClass("shadow");
